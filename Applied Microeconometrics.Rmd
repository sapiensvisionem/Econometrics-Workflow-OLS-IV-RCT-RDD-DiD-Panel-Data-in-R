...
Some of the applications of randomized control trial in socioeconomic field are:
...
### Randomization Check
For random assignemnt to work, we need the independence assumption between treatment and other control variables. Also, we should not observe any observed or unobserved differences between treated or untreated. There are informal tests to see whether is a problem with randomization:
